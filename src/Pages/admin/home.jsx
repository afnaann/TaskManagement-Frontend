        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
          ...
          <div className="p-6 bg-white rounded-xl shadow-lg dark:bg-gray-800 h-48 flex items-center justify-center">
            <div className="flex items-center">
              ...
              <div className="ml-6">
                <p className="mb-2 text-lg font-medium text-gray-600 dark:text-gray-400">Total Assignments</p>
          ...
          <div className="p-6 bg-white rounded-xl shadow-lg dark:bg-gray-800 h-48 flex items-center justify-center">
            <div className="flex items-center">
              ...
              <div className="ml-6">
                ...
                <p className="text-2xl font-semibold text-gray-900 dark:text-white">280</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 bg-white rounded-xl shadow-lg dark:bg-gray-800 h-48 flex items-center justify-center">
            <div className="flex items-center">
              ...
              <div className="ml-6">
                ...
                <p className="text-2xl font-semibold text-gray-900 dark:text-white">40</p>
              </div>
            </div>
          </div>
        </div>
