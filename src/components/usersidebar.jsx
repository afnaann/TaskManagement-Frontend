        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <Link
                ...
                className={`flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${
                  isActive("/home") ? "bg-gray-200 dark:bg-black" : "text-gray-900 dark:text-white"
                }`}
              >
                <svg
            ...
            <li>
              ...
              to={"/tasks"}
                className={`flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${
                  isActive("/tasks") ? "bg-gray-200 dark:bg-gray-900" : "text-gray-900 dark:text-white"
                }`}
              >
                <svg
                  className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            ...
            <li>
              ...
              to={"/tasksubmit"}
                className={`flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${
                  isActive("/tasksubmit") ? "bg-gray-200 dark:bg-gray-900" : "text-gray-900 dark:text-white"
                }`}
              >
                <svg
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Submit Tasks</span>
              </Link>
            </li>
          </ul>
        </div>
